...
public sealed class MigratorOptions
{
    ...
    public string ExpectedRole { get; init; } = "xanhnow_security_migrator";
...
public sealed class MigratorCredentialOptions
{
    ...
    public string VaultSecretPath { get; init; } = "kv/xanhnow/security/postgres/migration";
    public string VaultField { get; init; } = "SecurityMigratorDb";
}
