...
public sealed record TokenPairResponse([property: SensitiveData("access-token")] string AccessToken, [property: SensitiveData("refresh-token")] string RefreshToken, DateTimeOffset AccessTokenExpiresAtUtc, DateTimeOffset RefreshTokenExpiresAtUtc, string? SessionId, string TokenType = "Bearer");
